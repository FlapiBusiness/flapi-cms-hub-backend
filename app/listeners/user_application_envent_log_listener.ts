...
/**
 * Listener to send logs to NATS for user-related actions
 * @class NewUserLogsListener
 */
export default class NewUserLogsListener {
  /**
  ...
  public async handle(event: ApplicationEventLogListenerPayload): Promise<void> {
    ...
    await NatsService.publish('new-user-logs', {
